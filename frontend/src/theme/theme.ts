  ...
  return createTheme({
    ...
    components: {
      MuiCssBaseline: {
        styleOverrides: {
          ':root': {
            '--semantic-accent-main': '#534AB7',
            '--semantic-risk-text': '#E24B4A',
            '--semantic-risk-bg': '#FCEBEB',
            '--semantic-risk-border': '#E24B4A',
            '--semantic-missing-text': '#EF9F27',
            '--semantic-missing-bg': '#FAEEDA',
            '--semantic-missing-border': '#EF9F27',
            '--semantic-reliability-high-text': '#3B6D11',
            '--semantic-reliability-high-bg': '#EAF3DE',
            '--semantic-reliability-medium-text': '#854F0B',
            '--semantic-reliability-medium-bg': '#FAEEDA',
            '--semantic-reliability-low-text': '#A32D2D',
            '--semantic-reliability-low-bg': '#FCEBEB',
            '--semantic-model-badge-bg': '#EEEDFE',
            '--semantic-model-badge-text': '#3C3489',
            '--semantic-pastel-green': '#EAF3DE',
            '--semantic-pastel-purple': '#EEEDFE',
            '--semantic-pastel-teal': '#DFF5F4',
            '--semantic-pastel-blue': '#E8F1FF',
            '--semantic-pastel-red': '#FCEBEB',
            '--semantic-cta-chip-bg': '#EAF3DE',
            '--semantic-cta-chip-border': '#3B6D11',
            '--semantic-cta-chip-text': '#3B6D11',
            '--semantic-evidence-accent': '#4C87E8',
            '--semantic-brief-border': isDark ? '#2D2D2D' : '#D8E7F5',
            '--semantic-brief-hover': isDark ? 'rgba(255,255,255,0.04)' : '#F2F6FC',
            '--semantic-brief-pill-bg': isDark ? 'rgba(255,255,255,0.06)' : '#F3F5FA',
            '--semantic-brief-sticky-bg': isDark ? 'rgba(26,26,26,0.95)' : 'rgba(255,255,255,0.95)',
            '--semantic-text-primary': isDark ? '#ffffff' : '#0F2238',
            '--semantic-text-secondary': isDark ? '#c3ceda' : '#52708D',
            '--semantic-text-muted': isDark ? '#9eb0c2' : '#7A8FA8',
          },
          body: {
